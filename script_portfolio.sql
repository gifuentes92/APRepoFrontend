...
-- -----------------------------------------------------
-- Table `MiPortfolio`.`Conocimientos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MiPortfolio`.`Conocimientos` (
...
-- -----------------------------------------------------
-- Table `MiPortfolio`.`extra`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MiPortfolio`.`extra` (
  `idextra` INT NOT NULL AUTO_INCREMENT,
  `Habilidad` VARCHAR(45) NULL,
  `Programa` VARCHAR(45) NULL,
  `Persona_id` INT NOT NULL,
  PRIMARY KEY (`idextra`),
  INDEX `fk_extra_Persona1_idx` (`Persona_id` ASC),
...
-- -----------------------------------------------------
-- Table `MiPortfolio`.`idioma`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MiPortfolio`.`idioma` (
...
-- -----------------------------------------------------
-- Table `MiPortfolio`.`Localidad`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MiPortfolio`.`Localidad` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `Nombre` VARCHAR(45) NOT NULL,
  `Persona_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_Localidad_Persona1_idx` (`Persona_id` ASC) ,
  CONSTRAINT `fk_Localidad_Persona1`
    FOREIGN KEY (`Persona_id`)
    REFERENCES `MiPortfolio`.`Persona` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `MiPortfolio`.`Provincia`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MiPortfolio`.`Provincia` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `Nombre` VARCHAR(45) NOT NULL,
  ...
  CONSTRAINT `fk_Provincia_Localidad1`
    ...
    REFERENCES `MiPortfolio`.`Localidad` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
